---
description: Answer a question about the codebase (Sonnet)
argument-hint: <question>
---

Use the ans-sonnet agent to answer this question. Focus on providing a clear, comprehensive answer.
